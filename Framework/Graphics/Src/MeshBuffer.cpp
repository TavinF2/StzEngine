...
void StzEngine::Graphics::MeshBuffer::Initialize(const void* vertices, uint32_t vertexSize, uint32_t vertexCount)
{
	CreateVertexBuffer(vertices, vertexSize, vertexCount);
}

void StzEngine::Graphics::MeshBuffer::Initialize(const void* vertices, uint32_t vertexSize, uint32_t vertexCount, const void* indices, uint32_t indexCount)
{
	CreateVertexBuffer(vertices, vertexSize, vertexCount);
	CreateIndexBuffer(indices, indexCount);
}

void StzEngine::Graphics::MeshBuffer::Terminate()
{
	SafeRelease(mVertexBuffer);
	SafeRelease(mIndexBuffer);
}

void StzEngine::Graphics::MeshBuffer::Update(const void* vertices, uint32_t vertexCount)
{
...
void StzEngine::Graphics::MeshBuffer::SetTopology(Topology topology)
{
	switch (topology)
	{
...
void StzEngine::Graphics::MeshBuffer::Render() const
{
	auto context = GraphicsSystem::Get()->GetContext();
...
void StzEngine::Graphics::MeshBuffer::CreateVertexBuffer(const void* vertices, uint32_t vertexSize, uint32_t vertexCount)
{
...
void StzEngine::Graphics::MeshBuffer::CreateIndexBuffer(const void* indices, uint32_t indexCount)
{
	if (indexCount == 0)
	{
		return;
