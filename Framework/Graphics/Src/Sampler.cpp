...
namespace
{
    D3D11_FILTER GetFilter(Sampler::Filter filter)
    {
        switch (filter)
        {
        case StzEngine::Graphics::Sampler::Filter::Point:          return D3D11_FILTER_MIN_MAG_MIP_POINT;
        case StzEngine::Graphics::Sampler::Filter::Linear:         return D3D11_FILTER_MIN_MAG_MIP_LINEAR;
        case StzEngine::Graphics::Sampler::Filter::Anisotropic:    return D3D11_FILTER_ANISOTROPIC;
        default:
    ...
    D3D11_TEXTURE_ADDRESS_MODE GetAddressMode(Sampler::AddressMode addressMode)
    {
        switch (addressMode)
        {
        case StzEngine::Graphics::Sampler::AddressMode::Border:    return D3D11_TEXTURE_ADDRESS_BORDER;
        case StzEngine::Graphics::Sampler::AddressMode::Clamp:     return D3D11_TEXTURE_ADDRESS_CLAMP;
        case StzEngine::Graphics::Sampler::AddressMode::Mirror:    return D3D11_TEXTURE_ADDRESS_MIRROR;
        case StzEngine::Graphics::Sampler::AddressMode::Wrap:      return D3D11_TEXTURE_ADDRESS_WRAP;
        default:
