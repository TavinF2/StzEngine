...
void StzEngine::Core::Window::Initialize(HINSTANCE instance, const std::wstring& appName, uint32_t width, uint32_t height)
{
	mInstance = instance;
	mAppName = appName;
	WNDCLASSEX wcex;
...
void StzEngine::Core::Window::Terminate()
{
...
void StzEngine::Core::Window::ProcessMessage()
{
	MSG msg{};
...
HWND StzEngine::Core::Window::GetWindowHandle() const
{
	return mWindow;
}

bool StzEngine::Core::Window::IsActive() const
{
	return mIsActive;
}
